...
namespace Kyzlyk.Helpers.GMesh
{
    public struct GMeshUtility
    {
        public static void AddCube(MeshStructure meshStructure, Vector3 position, float scale = 1)
        {
            ...
            SetLastVerticesOfTrianglesOfSquare(meshStructure);
        ...
        public static MeshStructure GetCube(Vector3 position, int verticesCount, float scale = 1)
        {
            ...
            meshStructure.Vertices.AddRange(GetLeftSideSquare(position, scale));
            SetLastVerticesOfTrianglesOfSquare(meshStructure, verticesCount + meshStructure.Vertices.Count);
        ...
        public static void SetLastVerticesOfTrianglesOfSquare(MeshStructure meshStructure)
        {
        ...
        public static void SetLastVerticesOfTrianglesOfSquare(MeshStructure meshStructure, int verticesCount)
        {
